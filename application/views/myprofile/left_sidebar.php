...
<div class="side-menu"> 
	...
	<div class="side-menu-container">
		<ul class="nav navbar-nav">
			<li class="<?php echo ($this->uri->segment(1) == 'my_account' && $this->uri->segment(2) == '')? 'active':''; ?>"><a href="<?php echo base_url('my_account'.$get_id);?>">General</a></li>
			...
			<li class="<?php echo ($this->uri->segment(2) == 'letter_issued_readonly_emp' || $this->uri->segment(2) == 'letter_issued_update_emp')? 'active':''; ?>"><a href="<?php echo base_url('my_account/letter_issued_readonly_emp'.$get_id);?>">Letter Issued</a></li> 
		</ul>
	</div><!-- /.navbar-collapse -->
	</nav> 
</div> 
