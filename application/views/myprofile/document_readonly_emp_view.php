		...
		<div class="form-content page-content">
			<div class="mt mb">
				...
				<div class="col-md-9 center-xs">
					<!--<a href="<?php //echo base_url('my_account/document_update_emp'); ?>" class="btn btn-primary pull-right" role="button" style="margin-right: 10px; margin-top: 4px;"><i class="fa fa-upload" aria-hidden="true"></i>&nbsp;Upload</a>-->
