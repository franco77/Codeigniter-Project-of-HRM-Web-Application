			...
			<div class="mt mb">
				...
				<div class="col-md-9 center-xs"> 
					<?php if($this->session->userdata('user_type') != 'EMP' ){ ?>
						<a href="<?= base_url('my_account/salary_profile_readonly_emp'.$get_id);?>" class="btn btn-primary pull-right" role="button" style="margin-right: 10px; margin-top: 4px;"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>&nbsp;View</a> 
					<?php } ?>
