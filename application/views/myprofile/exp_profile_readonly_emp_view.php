		...
		<div class="form-content page-content">
			<div class="mt mb">
				...
				<div class="col-md-9 center-xs"> 
					...
					<?php $counter=0; if(count($reqSkill) >0){ 
					
					foreach($reqSkill as $key => $valskill){ $counter = $counter + 1;?>	
						
						<div class="table-responsive">
								<table class="table table-striped table-bordered table-condensed">  
									<tr class="info"><td colspan="4" class="form_title" style="text-align:center; text-transform:uppercase;"><strong>Special Skill <?php echo $counter; ?> </strong></td></tr>
									<tr>
									<td width="20%" valign="top"><span class="red">&nbsp;</span> <strong>Skill Name:</strong></td>
									   <td width="20%" valign="top"><?php echo $valskill['skill_name'] ;?></td>
										
										
										<td width="20%" valign="top"><span class="red">&nbsp;</span> <strong>Experience:</strong></td>
										<td width="20%" valign="top"><?php echo $valskill['skill_exp'] ;?> Months</td>
