		...
		<div class="form-content page-content">
			<div class="mt mb">
				...
				<div class="col-md-9 center-xs">  
					<a href="<?= base_url('my_account/family_profile_readonly_emp'.$get_id);?>" class="btn btn-primary pull-right" role="button" style="margin-right: 10px; margin-top: 4px;"><i class="fa fa-eye" aria-hidden="true"></i>&nbsp;View</a>
							...
							<form id="frmFamilyUpdate" name="frmFamilyUpdate" method="POST" action="" enctype="multipart/form-data">
								<table class="table table-striped table-bordered table-condensed">
									<tr>
										...
										<td width="20%" valign="top"><input type="text" id="txtfather_dob" readonly name="txtfather_dob" value="<?php echo date('d-m-Y',strtotime($empInfo[0]['fathers_dob']));?>" class="required cal form-control" style="width:190px; margin-bottom: 10px;" /></td>
                                    </tr>
                                    <tr>
										...
										<td width="20%" valign="top"><input type="text" id="txtmother_dob" readonly name="txtmother_dob" value="<?php echo date('d-m-Y',strtotime($empInfo[0]['mother_dob']));?>" class="required cal form-control" style="width:190px; margin-bottom: 10px;" /></td>
                                    </tr>
                                    ...
                                    <tr>
										...
										<td width="20%" valign="top"><input type="text" id="txtspouse_dob" name="txtspouse_dob" readonly  value="<?php echo date('d-m-Y',strtotime($empInfo[0]['spouse_dob']));?>" class="cal form-control" style="width:190px; margin-bottom: 10px;" /></td>
									</tr>
									<tr>
										<td width="30%" valign="top"><span class="red">&nbsp;</span> <strong>Anniversary Date:</strong></td>
										<td width="20%" valign="top"><input type="text" id="txtanniversary_date" name="txtanniversary_date" readonly value="<?php echo date('d-m-Y',strtotime($empInfo[0]['anniversary_date']));?>" class="cal form-control" style="width:190px; margin-bottom: 10px;" /></td>
										<td colspan="2">&nbsp;</td>
									</tr>
                                    <?php } ?>
								</table>
								...
								<div class="row submtSec" style="margin-bottom: 20px;">
									...
									<div class="col-md-3 pull-right">
										<span class="pull-right">
											<input type="button" id="btnAddChild" name="btnAddChild" class="btn btn-info pull-right" value="Add" onclick="AddFamily(this);" />
										</span>
									</div>
								</div>
                                <div class="clear"></div>
						...
						{   
                            ...
                            foreach($childInfo_arr as $childInfo)
                            {
								...
								$childdob = date("d-m-Y", strtotime($childInfo["child_dob"]));
                                    ?> </br>
										<div class="table-responsive">
											<form id="frmChildUpdate_<?php echo $childInfo['child_id']?>" name="frmChildUpdate" method="POST" action="" enctype="multipart/form-data">
											<table class="table table-striped table-bordered table-condensed">
												<tr>
