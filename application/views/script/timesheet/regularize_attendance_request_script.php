...
myapp.controller('RegularizeAttendance', ['$http','$scope', '$timeout',  '$window', function ($http, $scope,$timeout,$window) 
{   
    $scope.init = function(base_url,data)
    {
        $scope.base_url=base_url; 
        $http.get($scope.base_url+'Timesheet/get_regularize_attendance_request').
        ...
        $scope.advanceFilter = function() {
			...
			$http({
				method: 'POST', 
				url: $scope.base_url+'Timesheet/get_regularize_attendance_request_search',
        ...
        $scope.leaveApporved = function(application_id) {
			...
			$http({
				method: 'POST', 
				url: $scope.base_url+'Timesheet/update_regularise_request_approved',
				headers: {'Content-Type': undefined},  
				data: formdata
			}).
			success(function(response) {
        ...
        $scope.leaveRejected = function(application_id) {
			...
			$http({
				method: 'POST', 
				url: $scope.base_url+'Timesheet/update_regularise_request_rejected',
				headers: {'Content-Type': undefined},  
				data: formdata
			}).
			success(function(response) {
