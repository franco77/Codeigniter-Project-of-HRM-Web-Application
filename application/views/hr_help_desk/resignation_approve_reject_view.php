		...
		<div class="form-content">
			<div class="mt mb">
				...
				<div class="col-md-9 center-xs">
					<legend class="pkheader">All Employee Under You Applied Resignation Letter</legend> 
					<div class="row well">
							...
							<table class="table table-striped table-hover">
								...
								<tbody>
									<tr ng-repeat="data in filtered = (getcustname | filter:search | orderBy : predicate :reverse) | startFrom:(currentPage-1)*entryLimit | limitTo:entryLimit"> 
										<td><a href="#" data-toggle="modal" data-target="#myModal_{{data.rid}}">{{data.name_first}}</a></td>
										...
										<td>
											<span  ng-if="data.rm_status == 0 && data.emp_status == 0" >
												<div class="iCompassTip" >
													<img  class="leaveApprove" src="<?php echo base_url(); ?>assets/images/icon/approve.png" alt="" title="Approve" data-toggle="modal" data-target="#approveReson_{{data.rid}}" style="cursor: pointer;" />
												...
												<div class="modal fade" id="approveReson_{{data.rid}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
															...
															<div class="modal-header">
															 <button type="button" class="close" data-dismiss="modal">&times;</button>
																...
																<div class="modal-footer">
																	...
																	<button type="button" name="can_submit" value="cancel_leave" class="btn btn-success"  ng-click="resignationApporved(data.rid, this);" >Submit</button>
																</div>
														</div>
													</div>
												</div>
											...
											<span class="label label-info" ng-if="data.rm_status == 0 && data.emp_status == 0" >Active</span>
