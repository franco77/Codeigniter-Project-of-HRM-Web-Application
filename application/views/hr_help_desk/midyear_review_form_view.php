						  ...
						  <fieldset> 
								...
								<div class="table-responsive">
									<table class="table table-striped table-bordered table-condensed">
										<tbody> 
														 ...
														 <tbody>
															...
															<tr valign="top">
																<td>
																	...
																	<p><?php if($get_id!=''){ echo 'disabled=""'; }?> <?php echo $rowGoal[$m]['objective']; ?></p>
																</td>
																...
																<td>
																	<textarea name="comment[]" class="search_UI  form-control commentss" rows="10" <?php if($get_id!=''){ echo 'disabled=""'; } ?> style="min-width: 225px;max-width: 110px;" required=""><?php echo $rowGoal[$m]['comment']; ?></textarea>
																</td>
																
																<td>
																	<input type="checkbox" <?php if($get_id==''){ echo 'disabled=""'; } ?> name="rating[]" <?php if($rowGoal[$m]['rating']=='Progressing'){ echo "checked";} ?> value="Progressing" /> Progressing<br/>
																	<input type="checkbox" <?php if($get_id==''){ echo 'disabled=""'; } ?> name="rating[]" <?php if($rowGoal[$m]['rating']=='NotProgressing'){ echo "checked"; } ?> value="NotProgressing" /> Not Progressing
																</td>
															</tr> 
															   <?php } ?>
														</tbody>
											...
											<tr>
												<td colspan="3"><textarea name="exceeding_expectation" class="form-control" rows="3" cols="25"  id="exceeding_expectation" style="min-width: 789px; max-width: 789px;"><?php if(count($rowAppraisal)>0) echo $rowAppraisal[0]['exceeding_expectation']; ?></textarea></td>
											</tr> 
											<tr>
											...
											<tr>
												<td colspan="3"><textarea name="improvement" class="form-control" rows="3" cols="25"   id="improvement" style="min-width: 789px; max-width: 789px;"><?php if(count($rowAppraisal)>0) echo $rowAppraisal[0]['improvement']; ?></textarea></td>
												</td>
											</tr> 
											<tr>
											...
											<tr>
												<td colspan="3"><textarea name="discussion" class="form-control" rows="3" cols="25"  id="discussion" style="min-width: 789px; max-width: 789px;"><?php if(count($rowAppraisal)>0) echo $rowAppraisal[0]['discussion']; ?></textarea></td>
											</tr> 
											...
											<tr>
												<td colspan="3"><textarea name="summary_expectation" class="form-control" rows="3" cols="25"  id="summary_expectation" style="min-width: 789px; max-width: 789px;"><?php if(count($rowAppraisal)>0) echo $rowAppraisal[0]['summary_expectation']; ?></textarea></td>
											</tr> 
											<tr>
											...
											<tr>
												<td colspan="3"><textarea name="employee_development" class="form-control" rows="3" cols="25"  id="employee_development" style="min-width: 789px; max-width: 789px;"><?php if(count($rowAppraisal)>0) echo $rowAppraisal[0]['employee_development']; ?></textarea></td>
											</tr>
							...
							<div class="form-group">
								...
								<div class="col-md-3 pull-right"> 
									...
									<input type="submit" id="btnAddMessage" name="btnAddMessage" class="btn btn-info" value="<?php if($get_id!='') echo 'APPROVE'; else echo "APPLY"; ?>" />
