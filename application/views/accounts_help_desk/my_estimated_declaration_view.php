		...
		<div class="form-content page-content">
			<div class="mt mb">
				...
				<div class="col-md-9 center-xs"> 
					<legend class="pkheader">My Estimated Income Tax Declaration Details</legend>
					<div class="row well"> 
										...
										if($result >0)
										{
											...
											{?>
												<tr <?php if($i % 2 == 0)echo 'class="odd"'?>>
													...
													{?>
														<a href="<?= base_url('en/accounts_help_desk/estimated_declaration_form?id='.$get_my_estimate[$i]['tid'])?>"><img alt="Edit" style="cursor: pointer;" src="<?= base_url('assets/images/icon/edit.png')?>" /></a> 
													<?php } ?>
													</td>
												</tr>
												<?php  
