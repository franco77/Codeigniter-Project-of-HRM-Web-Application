			...
			<div class="mt mb">
				...
				<div class="col-md-9 center-xs">
					<legend class="pkheader">Income Tax Declaration(FINAL) <?php 
							...
							{
								echo $result[0]['name_first'].'&nbsp;'.$result[0]['name_last'];
							}
							else
							{
						...
						<form id="frmSalaryUpdate" name="frmSalaryUpdate" method="POST" action="" enctype="multipart/form-data" class="form-horizontal">
							<div class="table-responsive">
								<table class="table table-striped table-bordered">
									<thead>
										<tr class="info">
											<th>For the Financial Year <?php echo (string)$fyear.'-'.(string)($fyear+1); ?></th>
											<th>Declared</th>
											<th>Eligible</th>
										</tr>
									</thead>
									<tbody>
										...
										<tr>
											...
											<td valign="top">
												<input type="text" id="income_tax_declaration5" name="childreneducationalallowance" value="<?php if($estimatedValue[0]['childreneducationalallowance'] !='0.00'){ if(count($empInfo) > 0){ echo $empInfo[0]['childreneducationalallowance']; } } else { echo 'NA';}?>" <?php if($estimatedValue[0]['childreneducationalallowance'] =='0.00'){ echo 'readonly ';}  ?> class="numbersOnly form-control" style="width:100px; margin-bottom: 10px;" />
											</td>
											<td valign="top">
										...
										<tr class="info">
											<td colspan="3" class="form_title"><strong>Deductions U/s 80CCD (1B) Contribution to NPS Rs 50000</strong></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td valign="top">
												<input type="text" id="income_tax_declaration40" name="eligible_senior_citizen_60" value="<?php if(count($empInfo) > 0) echo $empInfo[0]['eligible_senior_citizen_60'];?>"  READONLY class="numbersOnly qnt80ddb form-control" style="width:100px; margin-bottom: 10px;" />
										...
										<tr>
											...
											<td valign="top">
												<input type="text" id="income_tax_declaration49" name="actual_donation_80g" value="<?php if($estimatedValue[0]['actual_donation'] !='0.00'){ if(count($empInfo) > 0){ echo $empInfo[0]['actual_donation_80g']; } }  ?>"   class="numbersOnly form-control" style="width:100px; margin-bottom: 10px;" />
											</td>
											<td valign="top">
												<input type="text" id="income_tax_declaration50" name="eligible_actual_donation_80g" value="<?php if($estimatedValue[0]['actual_donation'] !='0.00'){ if(count($empInfo) > 0){ echo $empInfo[0]['eligible_actual_donation_80g']; } }  ?>" READONLY class="numbersOnly form-control" style="width:100px; margin-bottom: 10px;" />
							...
							<div class="form-group"> 
								<?php if($this->config->item('finalTaxFormFreeze') == 'NO'){ ?>
									<div class="col-md-12">
										<?php if($revInfo[0]['login_id'] == $this->session->userdata('user_id')  && $this->session->userdata('user_type') == 'AC'){ echo "if"; ?>
										...
										<?php } elseif($this->input->get('id') != ''  && $this->session->userdata('user_type') == 'AC'){ echo "elseif"; ?>
											<input type="submit" id="btnRejectMessageRM" name="btnRejectMessageRM" class="btn btn-info pull-right" value="Reject" />
											<input type="submit" id="btnAddMessageRM" name="btnAddMessageRM" onclick="return(formValidateRM());" class="btn btn-info pull-righ" value="<?php if($this->input->get('id')!='') echo 'APPROVE'; else echo "APPLY"; ?>" />
										<?php } else{ ?>
