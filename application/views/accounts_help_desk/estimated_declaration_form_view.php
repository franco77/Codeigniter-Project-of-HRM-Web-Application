					...
					<div class="row well">
						...
						<form id="frmSalaryUpdate" name="frmSalaryUpdate" method="POST" action="" enctype="multipart/form-data" class="form-horizontal">
								...
								<table class="table table-striped table-bordered">
									...
									<tbody>
										...
										<tr>
											...
											<td valign="top">
												<?php 
													$doj = date("d-m-Y", strtotime($result[0]['join_date']));
							...
							<div class="form-group"> 
								<?php if($this->config->item('estimatedTaxFormFreeze') == 'NO'){ ?>
							
								<div class="col-md-12">
									<?php if($revInfo[0]['login_id'] == $this->session->userdata('user_id') && $this->session->userdata('user_type') == 'AC'){ ?>
									...
									<?php } elseif($this->input->get('id')!=''&& $this->session->userdata('user_type') == 'AC'){ ?>
