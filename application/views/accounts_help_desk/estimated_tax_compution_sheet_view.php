		...
		<div class="form-content page-content">
			<div class="mt mb">
				...
				<div class="col-md-9 center-xs"> 
					<form action="<?= base_url('accounts_help_desk/estimated_tax_compution_sheet')?>" method="POST" class="form-horizontal"  id="formSubmit" >
					...
					<legend class="pkheader">Tax Estimation</legend>
					<div class="row well">
						<div class="table-responsive">
							<table class="table table-striped table-bordered table-condensed">
								<div class="embed-responsive embed-responsive-4by3">
								  <iframe class="embed-responsive-item" src="<?php echo base_url('accounts_help_desk/estimated_tax_compution_sheet_result?fyear='.$fyear);?>"></iframe>
								</div>
							</table>
						</div>
						<!-- /.table-responsive -->
