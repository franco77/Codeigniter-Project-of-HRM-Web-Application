                            ...
                            <table class="table table-striped table-bordered table-condensed">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $empInfo[0]['highest_qual'];?></td>
                                    </tr>
                                    <tr>
                                        <td><strong>Location of H. Qualif:</strong></td>
                                        <td><?php
                                            if($empInfo[0]['loc_highest_qual'] != '' && $empInfo[0]['loc_highest_qual'] != '0') echo $empInfo[0]['loc_highest_qual'];
                                            	?>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3"><?php
                                            ...
                                            echo '</strong> My Mobile No on AABSyS Staff Directory.';
                                            ?>                                          
                                        </td>
                                    </tr>
                                    <tr class="info">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $empInfo[0]['address1'];?></td>
                                        <td valign="top"><strong>Correspondence Address:</strong></td>
                                        <td><?php echo $empInfo[0]['address2'];?></td>
                                    </tr>
                                    <tr>
