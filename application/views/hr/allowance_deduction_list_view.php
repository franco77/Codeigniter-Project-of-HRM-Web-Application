...
<div class="section main-section" ng-app="myApp" ng-controller="allowanceList" ng-init="init('<?php echo base_url() ?>')">
    <div class="container"> 
							...
							<table class="table table-striped table-bordered table-condensed">
								...
								<tbody>
									<tr ng-repeat="data in filtered = (getprofilelist | filter:search | orderBy : predicate :reverse) | startFrom:(currentPage-1)*entryLimit | limitTo:entryLimit">
										<td>{{$index+1}}</td>
										<td><a ng-href="<?php echo base_url(); ?>en/hr/allowance_deduction?id={{data.login_id}}" ng-bind="data.name;" ></a> </td>
