...
<style>
	...
	h3{
		background: url(<?php echo base_url(); ?>assets/images/h3_blue_bg.jpg) repeat-x top;
		border-top: 1px solid #58a9bf;
		padding: 8px 10px;
		font-size: 18px;
		color: #fff;
...
<table>                                	
 ...
 <tr>
  ...
  <tr>
            <td><strong>&nbsp;</strong></td>
            <td width="10%">&nbsp;</td>
            <td><input type="text" value="4th Weeks" readonly="" style="width:100px; font-weight: bold; margin-left: 10px;" />
            <input type="text" value="8th Weeks" readonly="" style="width:100px; font-weight: bold; margin-left: 20px;" />
            <input type="text" value="12th Weeks" readonly="" style="width:100px; font-weight: bold; margin-left: 20px;" /></td>
         </tr>

  <tr>
            <td><strong>DATE</strong><span class="red">*</span> </td>
            <td width="10%">:</td>
            <td><input type="text" readonly="readonly"  id="4thweek" value="<?php echo $rowPA[0]['4thweek']; ?>" name="4thweek" class="required form_ui" style="width:100px; margin: 10px;" />
            <input type="text" readonly="readonly" id="8thweek" value="<?php echo $rowPA[0]['8thweek']; ?>" name="8thweek" class="required form_ui" style="width:100px; margin: 10px;" />
            <input type="text" readonly="readonly" id="12thweek" value="<?php echo $rowPA[0]['12thweek']; ?>" name="12thweek" class="required form_ui" style="width:100px; margin: 10px;" /></td>
         </tr>
