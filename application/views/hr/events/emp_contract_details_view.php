...
<div class="section main-section" ng-app="myApp" ng-controller="empContractList" ng-init="init('<?php echo base_url() ?>')">
    <div class="container"> 
		<div class="form-content page-content">
			<div class="mt mb">
				...
				<div class="col-md-9 center-xs"> 
					<legend class="pkheader">Contract Employee Details</legend>
