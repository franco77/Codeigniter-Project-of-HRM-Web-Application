		...
		<div class="form-content page-content">
			<div class="mt mb">
				...
				<div class="col-md-9 center-xs">
					<legend class="pkheader">Create New Emplyee <small>(POLOHRM Resources)</small></legend>
					<div class="well">  
								...
								<section>
									<div  class="col-md-12">
										...
										<div class="col-md-6">
											...
											<div class="form-group">
												<label for="inputCity"><font style="color:#f00;">*</font>&nbsp;Joining Type</label>
												<select name="emp_joining_type" id="emp_joining_type" class="form-control" required>
													<option value="">Select</option>
													<option value="NE" <?php if($this->input->post('emp_joining_type') == 'NE') echo 'selected="selected"';?>>New Employee</option>
													<option value="XE" <?php if($this->input->post('emp_joining_type') == 'XE') echo 'selected="selected"';?>>Ex-Employee</option>
												</select>
											</div>
											<div id="div_exEmployeeCode" style="display:none;">
												<input type="text" id="ex_employee_code" name="ex_employee_code" value="<?php echo $this->input->post('ex_employee_code')?>" placeholder="Ex-Employee Code" class="form-control">
											</div>
										</div> 
									</div>
									<div  class="col-md-12">
									...
									<div  class="col-md-12">
										...
										<div class="col-md-6"> 
											<div class="form-group">
												...
												<select id="ddlTypeEmp" name="ddlTypeEmp" class="form-control" required>
													...
													<option value="CO" <?php if($this->input->post('ddlTypeEmp') == 'CO') echo 'selected="selected"';?>>Consultant</option>
												</select>
											</div> 
											<div class="form-group">
											...
											<div class="form-group">
												...
												<div id="div_contractEndDate" style="display:none;">
										...
										<div class="col-md-6">
											...
											<div class="form-group">
												...
												<select name="ddlSrcHire" id="ddlSrcHire" class="form-control" required>
													<option>Select</option>
													<?php 
											...
											<div id="div_srcHireEmployee" style="display:none;">
												<select name="refered_employee" id="refered_employee"  class="form-control" required>
												<?php 
													$reporting_result = count($employeeDeatils);
													for($i=0; $i<$reporting_result; $i++)
													{?>
														<option value="<?php echo $employeeDeatils[$i]['login_id'];?>"><?php echo $employeeDeatils[$i]['name'].'('.$employeeDeatils[$i]['loginhandle'].')';?></option>
													<?php }
												?>
												</select>
											</div>
