			...
			<div class="mt mb">
				...
				<?php $this->load->view('hr/top_view');?>
					...
					<?php //if($this->session->userdata('user_type') != 'EMP' &&  (isset($_GET['id']))){ ?>
						<a href="<?= base_url('en/hr/salary_profile_update_emp'.$get_id);?>" class="btn btn-info pull-right btn-sm" role="button" style="margin-right: 10px; margin-top: 4px;"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>&nbsp;Edit</a> 
					<?php //} ?>
					<?php }  ?>
					...
					<div class="row well">
						<div class="table-responsive">
							<table class="table table-striped table-bordered table-condensed"> 
								<tbody>
									...
									<tr>
										...
										<td valign="top" width="20%"> <?php  if(($this->session->userdata('user_type') == 'ADMINISTRATOR') ||($this->session->userdata('user_type') == 'HRM')){ ?> <?php echo $empInfo[0]['gross_salary']?> <?php } ?></td>                                        
										<td valign="top" width="20%"><strong>Basic  </strong>(Upto 15,000):</td>
										<td valign="top" width="20%"><?php  if(($this->session->userdata('user_type') == 'ADMINISTRATOR') ||($this->session->userdata('user_type') == 'HRM')){ ?>  <?php echo $empInfo[0]['fixed_basic']?><?php } ?></td>
									
									</tr>
									<tr>
										<td valign="top"> <strong>Basic</strong> <span id="basic_p">(% of Gross)</span> :</td>
										<td valign="top"><?php  if(($this->session->userdata('user_type') == 'ADMINISTRATOR') ||($this->session->userdata('user_type') == 'HRM')){ ?> <?php echo $empInfo[0]['basic']?><?php } ?></td>
									<td valign="top"> <strong>HRA</strong> <span id="hra_p">(% of Basic)</span> :</td>
										<td valign="top"><?php  if(($this->session->userdata('user_type') == 'ADMINISTRATOR') ||($this->session->userdata('user_type') == 'HRM')){ ?> <?php echo $empInfo[0]['hra']?><?php } ?></td>
									</tr>
									<tr>
										<td valign="top"> <strong>Conveyance Allowance</strong> :</td>
										<td valign="top"><?php  if(($this->session->userdata('user_type') == 'ADMINISTRATOR') ||($this->session->userdata('user_type') == 'HRM')){ ?> <?php echo $empInfo[0]['conveyance_allowance']?><?php } ?></td>  
										<td valign="top"> <strong>Reimbursement</strong> :</td>
										<td valign="top"><?php  if(($this->session->userdata('user_type') == 'ADMINISTRATOR') ||($this->session->userdata('user_type') == 'HRM')){ ?> <?php echo $empInfo[0]['reimbursement']?><?php } ?></td>
									 </tr>
									<tr>    
                                    ...
                                    <tr>
										...
										<td valign="top"><?php echo $empInfo[0]['acc_holder_name']?></td>
                                        <td valign="top"> </td>
										<td valign="top"></td>
							...
							<?php  if(($this->session->userdata('user_type') == 'ADMINISTRATOR') ||($this->session->userdata('user_type') == 'HRM')){ ?> 
							<?php 
                                $j=0;
