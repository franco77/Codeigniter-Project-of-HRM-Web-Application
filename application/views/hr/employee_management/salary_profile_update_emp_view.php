			...
			<div class="mt mb">
				...
				<?php $this->load->view('hr/top_view');?>
					<?php //if($this->session->userdata('user_type') != 'EMP' ){ ?>
						<a href="<?= base_url('en/hr/salary_profile_readonly_emp'.$get_id);?>" class="btn btn-primary pull-right" role="button" style="margin-right: 10px; margin-top: 4px;"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>&nbsp;View</a> 
					<?php //} ?>
								...
								<tbody>
									<tr class="info">
										...
										<td valign="top" colspan="2">
											...
											<?php /* ?><option value="A" <?php if($empInfo[0]['calculation_type'] == "A"){echo "selected='selected'";}?>>Automatic</option><?php */ ?>
                                    ...
                                    <?php /* ?>
										...
										<td valign="top" >
                                        <input type="hidden" id="txtpf_no" name="txtpf_no" value="<?php echo $empInfo[0]['pf_no']?>" class="required form-control" />
										...
										<td valign="top">
                                        <input type="hidden" id="txtuan_no" name="txtuan_no" value="<?php echo $empInfo[0]['uan_no']?>" class="required form-control" style="width:150px; margin-bottom: 10px;" />
                                        
                                        <input type="text" id="txtbank_no" name="txtbank_no" value="<?php echo $empInfo[0]['bank_no']?>" class="number form-control" style="width:150px; margin-bottom: 10px;" /></td>
                                        
									</tr>
									<?php /* ?><tr>
										
                                        <td valign="top"><strong>UAN No<span class="red">*</span> :</strong></td>
										<td valign="top"><input type="text" id="txtuan_no" name="txtuan_no" value="<?php echo $empInfo[0]['uan_no']?>" class="required form-control" style="width:150px; margin-bottom: 10px;" /></td>
									...
									<tr>
										...
										<td valign="top">
                                        <input type="hidden" id="txtmediclaim_no" name="txtmediclaim_no" value="<?php echo $empInfo[0]['mediclaim_no']?>" class="required form-control" style="width:150px; margin-bottom: 10px;" />
                                        <input type="text" id="txtbank_ifsc_code" name="txtbank_ifsc_code" value="<?php echo $empInfo[0]['ifsc_code']?>" class="number form-control" style="width:150px; margin-bottom: 10px;" /></td>
                                    ...
                                    <tr>										
										<td valign="top"><strong>Account Holder Name</strong></td>
										<td valign="top"><input type="text" id="txtbank_acc_holdername" name="txtbank_acc_holdername" value="<?php echo $empInfo[0]['acc_holder_name']?>" class="number form-control" style="width:150px; margin-bottom: 10px;" /></td>
