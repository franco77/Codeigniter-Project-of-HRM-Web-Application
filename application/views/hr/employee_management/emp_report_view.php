    ...
    <div class="container"> 
		<div class="form-content page-content">
			<div class="mt mb">
				...
				<div class="col-md-9"> 
					<legend class="pkheader">Employee Report&nbsp;&nbsp;&nbsp;<input type="checkbox" id="chooseall" name="chooseall" value="" /><label for="chooseall" style="font-size: 11px;">&nbsp;&nbsp;Choose All</label></legend>
					<div class="row well"> 
											...
											<div class="pad_10"> 
												...
												<div class="multiSelectSearchHolder">
													...
													<div id="ageBox" class="filterItem">
														<h5 class="reportpk">Age (in Months)</h5>
														<div class="form-row">
														  <div class="form-group col-md-6" style="padding:2px;">
															<input type="text" id="ageFrom" name="ageFrom" value="" placeholder="From" class="form-control" />
														</div>
														<div class="form-group col-md-6" style="padding:2px;">
															<input type="text" id="ageTo" name="ageTo" value="" placeholder="To" class="form-control" />
														</div>
														</div>
													</div>
													<div id="docBox" class="filterItem">
														<h5 class="reportpk">Date of Confirmation</h5>
														<div class="form-row">
														  <div class="form-group col-md-6" style="padding:2px;">
															<input type="text" id="docFrom" name="docFrom" value="" readonly placeholder="From" class=" form-control" />
														</div>
														<div class="form-group col-md-6" style="padding:2px;">
															<input type="text" id="docTo" name="docTo" value="" readonly placeholder="To" class=" form-control" />
														</div>
														</div>
													</div>
													<div id="levelBox" class="filterItem">
														<h5 class="reportpk">Level</h5>
														<div class="form-row">
														<div class="form-group col-md-6" style="padding:2px;">
															<input type="hidden" name="hdnLevel" id="hdnLevel" value="" />
															<select id="selLevel" name="selLevel[]" class="selectpicker" multiple="multiple">
															<?php 
													...
													<div id="gradeBox" class="filterItem">
														<h5 class="reportpk">Grade</h5>
														<div class="form-row">
														<div class="form-group col-md-6" style="padding:2px;">
															<input type="hidden" name="hdnGrade" id="hdnGrade" value="" />
															<select id="selGrade" name="selGrade[]" class="selectpicker" multiple>
															<?php 
													...
													<div id="loc_highest_qualActualBox" class="filterItem">
														<h5 class="reportpk">Location of Highest Qualification</h5>
														<div class="form-row">
														<div class="form-group col-md-6" style="padding:2px;">
															<input type="hidden" name="hdnLocHQ" id="hdnLocHQ" value="" />
															<select id="selLocationHQ" name="selLocationHQ[]" class="selectpicker" multiple>
															<?php 
													...
													<div id="locBox" class="filterItem">
														<h5 class="reportpk">Location</h5>
														<div class="form-row">
														<div class="form-group col-md-6" style="padding:2px;">
															<input type="hidden" name="hdnLoc" id="hdnLoc" value="" />
															<select id="selLocation" name="selLocation[]" class="selectpicker" multiple>
															<?php 
													...
													<div id="reportingBox" class="filterItem">
														<h5 class="reportpk">Reporting Officer</h5>
														<div class="form-row">
														<div class="form-group col-md-6" style="padding:2px;">
															<input type="hidden" name="hdnReporting" id="hdnReporting" value="" />
															<select id="selReporting" name="selReporting[]" class="selectpicker" multiple>
															<?php 
																$reporting_result = count($reporting);
																for($i=0; $i<$reporting_result; $i++)
																{?>
																	<option value="<?php echo $reporting[$i]['login_id'];?>"><?php echo $reporting[$i]['full_name'];?></option>
																<?php }
															?>
															</select>
														</div>
													...
													<div id="rev_officerBox" class="filterItem">
														<h5 class="reportpk">Reviewing Officer</h5>
														<div class="form-row">
														<div class="form-group col-md-6" style="padding:2px;">
															<input type="hidden" name="hdnReviewing" id="hdnReviewing" value="" />
															<select id="selReviewing" name="selReviewing[]" class="selectpicker" multiple>
															<?php 
																$reviewing_result = count($reviewing);
																for($i=0; $i<$reviewing_result; $i++)
																{?>
																	<option value="<?php echo $reviewing[$i]['login_id'];?>"><?php echo $reviewing[$i]['full_name'];?></option>
																<?php }
															?>
															</select>
														</div>
													...
													<div id="hodBox" class="filterItem">
														<h5 class="reportpk">Head of Department</h5>
														<div class="form-row">
														<div class="form-group col-md-6" style="padding:2px;">
															<input type="hidden" name="hdnHOD" id="hdnHOD" value="" />
															<select id="selHOD" name="selHOD[]" class="selectpicker" multiple>
															<?php 
																$hod_result = count($hod);
																for($i=0; $i<$hod_result; $i++)
																{?>
																	<option value="<?php echo $hod[$i]['login_id'];?>"><?php echo $hod[$i]['full_name'];?></option>
																<?php }
															?>
															</select>
														</div>
													...
													<div id="StateBox" class="filterItem">
														<h5 class="reportpk">Native State</h5>
														<div class="form-row">
														<div class="form-group col-md-6" style="padding:2px;">
															<input type="hidden" name="hdnState" id="hdnState" value="" />
															<select id="selState" name="selState[]" class="selectpicker" multiple>
															<?php 
													...
													<div id="genderBox" class="filterItem">
														<h5 class="reportpk">Gender</h5>
														<div class="form-row">
														<div class="form-group col-md-6" style="padding:2px;">
															<select id="selGender" name="selGender"  class="form-control" style="width:200px;">
													...
													<div id="marital_statusBox" class="filterItem">
														<h5 class="reportpk">Marital Status</h5>
														<div class="form-row">
														<div class="form-group col-md-6" style="padding:2px;">
															<select id="selMarital_status" name="selMarital_status"  class="form-control" style="width:200px;">
																<option value="">All</option>
													...
													<div id="exp_aabsysBox" class="filterItem">
														<h5 class="reportpk">Experience in Polosoft</h5>
														<div class="form-row"><div class="form-group col-md-6" style="padding:2px;">
															<input type="text" id="expAABSySFrom" name="expAABSySFrom" value="" placeholder="From" class="form-control" />
														</div>
														<div class="form-group col-md-6" style="padding:2px;">
															<input type="text" id="expAABSySTo" name="expAABSySTo" value="" placeholder="To" class="form-control" />
														</div>
														</div>
													</div>
													<div id="exp_othersBox" class="filterItem">
														<h5 class="reportpk">Experience Prior to Polosoft</h5>
														<div class="form-row"><div class="form-group col-md-6" style="padding:2px;">
															<input type="text" id="expOFrom" name="expOFrom" value="" placeholder="From" class="form-control" />
														</div>
														<div class="form-group col-md-6" style="padding:2px;">
															<input type="text" id="expOTo" name="expOTo" value="" placeholder="To" class="form-control" />
														</div>
														</div>
													</div>
													<div id="exp_totalBox" class="filterItem">
														<h5 class="reportpk">Total Experience</h5>
														<div class="form-row"><div class="form-group col-md-6" style="padding:2px;">
															<input type="text" id="expFrom" name="expFrom" value="" placeholder="From" class="form-control" />
														</div>
														<div class="form-group col-md-6" style="padding:2px;">
															<input type="text" id="expTo" name="expTo" value="" placeholder="To" class="form-control" />
														</div>
														</div>
													</div>
													<div id="basicBox" class="filterItem">
														<h5 class="reportpk">Basic</h5>
														<div class="form-row"><div class="form-group col-md-6" style="padding:2px;">
													...
													<div id="highest_qualBox" class="filterItem">
														<h5 class="reportpk">Highest Qualification</h5>
														<div class="form-row">
														<div class="form-group col-md-6" style="padding:2px;">
															<input type="hidden" name="hdnHQ" id="hdnHQ" value="" />
															<select id="selHQ" name="selHQ[]" class="selectpicker" multiple>
															<?php 
													...
													<div id="bankBox" class="filterItem">
														...
														<div class="form-group col-md-6" style="padding:2px;">
															...
															<select id="selBank" name="selBank[]" class="selectpicker" multiple>
															<?php 
													...
													<div id="graduationBox" class="filterItem">
														<h5 class="reportpk">Graduation</h5>
														<div class="form-row">
														<div class="form-group col-md-6" style="padding:2px;">
															<input type="hidden" name="hdnGraduation" id="hdnGraduation" value="" />
															<select id="selGraduation" name="selGraduation[]" class="selectpicker" multiple>
															<?php 
																$graduation_result = count($graduation);
																for($i=0; $i<$graduation_result; $i++)
																{?>
																	<option value="<?php echo $graduation[$i]['course_id'];?>"><?php echo $graduation[$i]['course_name'];?></option>
																<?php }
															?>
															</select>
														</div>
													...
													<div id="specializationGradBox" class="filterItem">
														<h5 class="reportpk">Specialization (Graduation)</h5>
														<div class="form-row">
														<div class="form-group col-md-6" style="padding:2px;">                                         
															<select id="selSpecializationGrad" name="selSpecializationGrad[]" class="selectpicker" multiple>
															<?php 
																$specialization_grade_result = count($specialization_grade);
																for($i=0; $i<$specialization_grade_result; $i++)
																{?>
																	<option value="<?php echo $specialization_grade[$i]['specialization_id'];?>"><?php echo $specialization_grade[$i]['specialization_name'];?></option>
																<?php }
															?>
															</select>                                        
														</div>
													...
													<div id="grad_passing_yearBox" class="filterItem">
														<h5 class="reportpk">Year of Passing (Graduation)</h5>
														<div class="form-row"><div class="form-group col-md-6" style="padding:2px;">
															<input type="text" id="gYOPFrom" name="gYOPFrom" value="" placeholder="From" class="form-control" />
														</div>
														<div class="form-group col-md-6" style="padding:2px;">
															<input type="text" id="gYOPTo" name="gYOPTo" value="" placeholder="To" class="form-control" />
														</div>
														</div>
													</div>
													<div id="grad_boardBox" class="filterItem">
														<h5 class="reportpk">Board/University (Graduation)</h5>
														<div class="form-row">
														<div class="form-group col-md-6" style="padding:2px;">
															<input type="hidden" name="hdngBorU" id="hdngBorU" value="" />
															<select id="selgBorU" name="selgBorU[]" class="selectpicker" multiple>
															<?php 
																$board_university_result = count($board_university);
																for($i=0; $i<$board_university_result; $i++)
																{?>
																	<option value="<?php echo $board_university[$i]['board_university_id'];?>"><?php echo $board_university[$i]['board_university_name'];?></option>
																<?php }
															?>
															</select>
														</div>
													...
													<div id="grad_percentageBox" class="filterItem">
														<h5 class="reportpk">Graduation Percentage</h5>
														<div class="form-row"><div class="form-group col-md-6" style="padding:2px;">
															<input type="text" id="grad_perFrom" name="grad_perFrom" value="" placeholder="From" class="form-control" />
														</div>
														<div class="form-group col-md-6" style="padding:2px;">
															<input type="text" id="grad_perTo" name="grad_perTo" value="" placeholder="To" class="form-control" />
														</div>
														</div>
													</div>
													<div id="edu_catGBox" class="filterItem">
														<h5 class="reportpk">Cat. of Education (Graduation)</h5>
														<div class="form-row">
														<div class="form-group col-md-6" style="padding:2px;">
															<select id="selEduCategoryG" name="selEduCategoryG"  class="form-control" style="width:200px;">
																<option value="">All</option>
													...
													<div id="professionalBox" class="filterItem">
														<h5 class="reportpk">Professional</h5>
														<div class="form-row">
														<div class="form-group col-md-6" style="padding:2px;">
															<input type="hidden" name="hdnProfessional" id="hdnProfessional" value="" />
															<select id="selProfessional" name="selProfessional[]" class="selectpicker" multiple>
															<?php 
																$professional_qualification_result = count($professional_qualification);
																for($i=0; $i<$professional_qualification_result; $i++)
																{?>
																	<option value="<?php echo $professional_qualification[$i]['course_id'];?>"><?php echo $professional_qualification[$i]['course_name'];?></option>
																<?php }
															?>
															</select>
														</div>
													...
													<div id="specializationProfBox" class="filterItem">
														<h5 class="reportpk">Specialization (Professional)</h5>
														<div class="form-row">
														<div class="form-group col-md-6" style="padding:2px;">                                         
															<select id="selSpecializationProf" name="selSpecializationProf[]" class="selectpicker" multiple>
															<?php 
																$specialization_professional_result = count($specialization_professional);
																for($i=0; $i<$specialization_professional_result; $i++)
																{?>
																	<option value="<?php echo $specialization_professional[$i]['specialization_id'];?>"><?php echo $specialization_professional[$i]['specialization_name'];?></option>
																<?php }
															?>
															</select>                                        
														</div>
													...
													<div id="prof_passing_yearBox" class="filterItem">
														<h5 class="reportpk">Year of Passing (Professional)</h5>
														<div class="form-row"><div class="form-group col-md-6" style="padding:2px;">
															<input type="text" id="pYOPFrom" name="pYOPFrom" value="" placeholder="From" class="form-control" />
														</div>
														<div class="form-group col-md-6" style="padding:2px;">
															<input type="text" id="pYOPTo" name="pYOPTo" value="" placeholder="To" class="form-control" />
														</div>
														</div>
													</div>
													<div id="prof_boardBox" class="filterItem">
														<h5 class="reportpk">Board/University (Professional)</h5>
														<div class="form-row">
														<div class="form-group col-md-6" style="padding:2px;">
															<input type="hidden" name="hdnpBorU" id="hdnpBorU" value="" />
															<select id="selpBorU" name="selpBorU[]" class="selectpicker" multiple>
															<?php 
																$board_university_result = count($board_university);
																for($i=0; $i<$board_university_result; $i++)
																{?>
													...
													<div id="prof_percentageBox" class="filterItem">
														<h5 class="reportpk">Professional Percentage</h5>
														<div class="form-row"><div class="form-group col-md-6" style="padding:2px;">
															<input type="text" id="prof_perFrom" name="prof_perFrom" value="" placeholder="From" class="form-control" />
														</div>
														<div class="form-group col-md-6" style="padding:2px;">
															<input type="text" id="prof_perTo" name="prof_perTo" value="" placeholder="To" class="form-control" />
														</div>
														</div>
													</div>
													<div id="edu_catPBox" class="filterItem">
														<h5 class="reportpk">Cat. of Education (Professional)</h5>
														<div class="form-row">
														<div class="form-group col-md-6" style="padding:2px;">
															<select id="selEduCategoryP" name="selEduCategoryP"  class="form-control" style="width:200px;">
																<option value="">All</option>
													...
													<div id="dopBox" class="filterItem">
														<h5 class="reportpk">Date of Promotion</h5>
														<div class="form-row">
														<div class="form-group col-md-6" style="padding:2px;">
															<input type="text" id="dopFrom" name="dopFrom" value="" readonly placeholder="From" class="cal form-control" />
														</div>
														<div class="form-group col-md-6" style="padding:2px;">
															<input type="text" id="dopTo" name="dopTo" value="" readonly placeholder="To" class="cal form-control" />
														</div>
														</div>
													</div>
													<div id="dobBox" class="filterItem">
														<h5 class="reportpk">Date of Birth</h5>
														<div class="form-row">
														<div class="form-group col-md-6" style="padding:2px;">
															<input type="text" id="dobFrom" name="dobFrom" value="" readonly placeholder="From" class="cal form-control" />
														</div>
														<div class="form-group col-md-6" style="padding:2px;">
															<input type="text" id="dobTo" name="dobTo" value="" readonly placeholder="To" class="cal form-control" />
														</div>
														</div>
													</div>
													<div id="anniversary_dateBox" class="filterItem">
														<h5 class="reportpk">Date of Anniversary</h5>
														<div class="form-row">
														<div class="form-group col-md-6" style="padding:2px;">
															<input type="hidden" name="hdnAnniversaryDate" id="hdnAnniversaryDate" value="" />
															<select id="selAnniversaryDate" name="selAnniversaryDate[]"  class="selectpicker" multiple>
													...
													<div id="blood_groupBox" class="filterItem">
														<h5 class="reportpk">Blood Group</h5>
														<div class="form-row">
														<div class="form-group col-md-6" style="padding:2px;">
															<input type="hidden" name="hdnBGroup" id="hdnBGroup" value="" />
															<select id="selBGroup" name="selBGroup[]"  class="selectpicker" multiple>
													...
													<div id="source_hireBox" class="filterItem">
														<h5 class="reportpk">Source of Hire</h5>
														<div class="form-row"><div class="form-group col-md-6" style="padding:2px;">
															<input type="hidden" name="hdnHire" id="hdnHire" value="" />
															<select id="selHire" name="selHire[]" class="selectpicker" multiple>
															<?php 
																$hire_result = count($sourcehire);
																for($i=0; $i<$hire_result; $i++)
																{?>
																	<option value="<?php echo $sourcehire[$i]['source_hire_id'];?>"><?php echo $sourcehire[$i]['source_hire_name'];?></option>
																<?php }
															?>
															</select>
														</div>
													...
													<div id="resignResonBox" class="filterItem">
														<h5 class="reportpk">Reason of Separation</h5>
														<div class="form-row">
														<div class="form-group col-md-6" style="padding:2px;">
															<input type="hidden" name="hdnReaSep" id="hdnReaSep" value="" />
															<select id="selReaSep" name="selReaSep[]" class="selectpicker" multiple>
															<?php 
													...
													<div id="emp_typeBox" class="filterItem">
														...
														<div class="form-row">
															<div class="form-group col-md-6" style="padding:2px;">
																...
																<select id="selEmpType" name="selEmpType[]"  class="selectpicker" multiple>
													...
													<div id="emp_status_typeBox" class="filterItem">
														<h5 class="reportpk">Employee Status Type</h5>
														<div class="form-row">
															<div class="form-group col-md-6" style="padding:2px;">
																<input type="hidden" name="hdnEmpStatusType" id="hdnEmpStatusType" value="" />
																<select id="selEmpStatusType" name="selEmpStatusType[]"  class="selectpicker" multiple>
													...
													<div id="user_statusBox" class="filterItem">
														...
														<div class="form-row">
															<div class="form-group col-md-6" style="padding:2px;">
																<select id="selEmpStatus" name="selEmpStatus"  class="form-control" style="width:200px;">
																	<option value="">All</option>
													...
													<div id="FnF_statusBox" class="filterItem">
														<h5 class="reportpk">FnF Status</h5>
														<div class="form-row">
															<div class="form-group col-md-6" style="padding:2px;">
																<select id="selFnFStatus" name="selFnFStatus"  class="form-control" style="width:200px;">
																	<option value="">All</option>
													...
													<div id="confirm_statusBox" class="filterItem">
														<h5 class="reportpk">Confirmation Status</h5>
														<div class="form-row">
															<div class="form-group col-md-6" style="padding:2px;">
																<select id="selConfStatus" name="selConfStatus"  class="form-control" style="width:200px;">
																	<option value="">All</option>
													...
													<div id="DORBox" class="filterItem">
														<h5 class="reportpk">Resignation Date</h5>
														<div class="form-row">
														<div class="form-group col-md-6" style="padding:2px;">
															<input type="text" id="dorFrom" name="dorFrom" value="" readonly placeholder="From" class="form-control" />
														</div>
														<div class="form-group col-md-6" style="padding:2px;">
															<input type="text" id="dorTo" name="dorTo" value="" readonly placeholder="To" class="form-control" />
														</div>
														</div>
													</div>
												</div>
