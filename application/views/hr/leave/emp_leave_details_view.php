...
<div class="section main-section" ng-app="myApp" ng-controller="empleaveinfo" ng-init="init('<?php echo base_url() ?>')">
    <div class="container"> 
		<div class="form-content page-content">
			<div class="mt mb">
				...
				<div class="col-md-9 center-xs"> 
					...
					<legend class="pkheader">Employee Leave Information ({{totalItems}})</legend> 
					<div class=" row well">
						<div class="row pkdsearch">
							 <legend class="form_title col-md-12">Track Employee Leave Information </legend>
							<div class="col-md-5">
							...
							<table class="table table-striped table-bordered table-condensed">
								<thead>
									<tr class="info">
										...
										<th width="17%" rowspan="2">Emp Code</th>
										<th width="15%" colspan="2">Starting</th>
										<th width="15%" colspan="2">Taken</th>
										<th width="15%" colspan="2">Current</th>
										<th width="15%" colspan="2">PL</th>
									</tr>
									<tr class="info">
										<th width="7.5%">PL</th>
										<th width="7.5%">SL</th>
										...
										<th width="7.5%">SL</th>
										<th width="7.5%">CF</th>
										<th width="7.5%">CASH</th>
									</tr>
								</thead>
								<tbody>
									<tr ng-repeat="data in filtered = (getleaveinfolist | filter:search | orderBy : predicate :reverse) | startFrom:(currentPage-1)*entryLimit | limitTo:entryLimit">
