				...
				<div class="col-md-9">
					<div class="form-content page-content">
						<div class="box-header">
							<h4 class="box-title">Download Salary Slip
								<small>Please select a month & Year</small>
							</h4>
							<?php //echo $msg;?>
							<form id="frmPhoneAdd" name="frmPhoneAdd" method="POST" action="">
								...
								<div class="form-group">
									<input type="submit" id="mailSalarySlip" name="mailSalarySlip" class="btn btn-primary pull-right" value="Download" /> 
								</div>
							</form>
						</div>
					</div>
