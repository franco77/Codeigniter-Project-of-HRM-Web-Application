											...
											<div class="pad_10">
												...
												<table width="100%" cellspacing="0" cellpadding="6" border="0"> 
													...
													<tr>
														...
														<td><label for="location">Location</label></td><td><input type="checkbox" class="chkColumns" id="location" name="location" /></td>
													</tr>
													<tr>
														<td><label for="income_tax">UAN No.</label></td><td><input type="checkbox" class="chkColumns" id="uan_no" name="uan_no" /></td>
													</tr>
												...
												<div class="multiSelectSearchHolder">
													...
													<div id="locationBox" class="filterItem">
														<h5 class="reportpk">Location</h5>                                  
														<div class="form-row">
															<div class="form-group col-md-6" style="padding:2px;">
																<select id="hdnLocation" name="hdnLocation[]" class="selectpicker" multiple>
																<?php 
