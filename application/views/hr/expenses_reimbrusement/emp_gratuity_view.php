		...
		<div class="form-content page-content">
			<div class="mt mb">
				...
				<div class="col-md-9 center-xs">
					<a href="<?= base_url('en/hr/emp_gratuity_export');?>" class="btn btn-primary pull-right " role="button" style="margin-right: 10px; margin-top: 4px;" target="_blank"><i class="fa fa-file-excel-o" aria-hidden="true"></i>&nbsp;Export To Excel</a>
