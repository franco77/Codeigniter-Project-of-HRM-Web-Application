    ...
    <div class="container"> 
		<div class="form-content page-content">
			<div class="mt mb">
				...
				<div class="col-md-9">
					<legend class="pkheader">Generate Arrears(<small>Please select a month & year.</small>)</legend> 
					<div class="row well"> 
						<form id="frmPhoneAdd" name="frmPhoneAdd" method="POST" action="">
							<div class="box-body pad"> 
								<div class="form-group">
									<label class="col-md-4 control-label" for="name">Generate Arrears For the Month of </label>  
									<div class="col-md-2"> 
									...
									<div class="col-md-2">
										<input type="submit" id="btnAddPhone" name="btnAddPhone" class="btn btn-info pull-right" value="GENERATE" <?php if($this->config->item('generateArrearsFreeze') == 'YES'){ echo "disabled"; } ?> /> 
									</div>
									<div class="col-md-12">
										<?php if($successMsg !=""){ ?>
