		...
		<div class="form-content page-content">
			<div class="mt mb">
				...
				<div class="col-md-9 center-xs">
					<legend class="pkheader">Director's Message</legend>
					<div class="row well">
						<div class="row pkdsearch">
							 <legend class="form_title col-md-12"><span id="formType"></span>Director's Message</strong> </legend>
							<div class="form">
								<div class="form1">
									<form id="directorMessage" name="directorMessage" method="POST">
										<div class="col-md-12">
											<div class="form-group row">
												<div class="col-sm-12">
													<textarea name="editor1" ><?php if(COUNT($message) > 0){ echo $message[0]['message']; }?></textarea>
												</div>
											</div>
										</div>
...
<script type="text/javascript">
	...
	frm.submit(function (e) {
        ...
        $.ajax({
            ...
            url: site_url+'en/hr/add_director_message',
            data: {data:CKEDITOR.instances.editor1.getData()},
            success: function (data) {
                console.log(data);
				$('#piMSG').html('Directors Message submitted Successfully');	
