    ...
    <div class="container"> 
		<div class="form-content page-content">
			<div class="mt mb">
				...
				<div class="col-md-9"> 
					<legend class="pkheader">Download Less Working Hour Report(<small>Please select a month & year.</small>)</legend> 
					<div class="row well">
						<form id="frmPhoneAdd" name="frmPhoneAdd" method="POST" action="">
							<div class="box-body pad"> 
								<div class="form-group">
									<label class="col-md-4 control-label" for="name">Download LWH Report For the Month of</label>  
									<div class="col-md-2"> 
									...
									<div class="col-md-2">
										<input type="submit" id="LHWReport" name="LHWReport" class="btn btn-info pull-right" value="Download" /> 
									</div>
									<div class="col-md-12">
										<?php if(isset($errMsg)){ if($errMsg != ""){ echo '<h5 style="color: #f00;">'.$errMsg.'</h5>'; } } ?>
									</div>
								</div> 
							</div> 
						</form>   
