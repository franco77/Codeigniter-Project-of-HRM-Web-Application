		...
		<div class="form-content">
			<div class="mt mb">
				...
				<div class="col-md-9 center-xs">  
					...
					<legend class="pkheader">Estimated Tax Declation Detail<small>(Resource of our Organisation)</small></legend>
					<div class="row well">
								...
								<tbody>
									<tr ng-repeat="data in filtered = (getestimated | filter:search | orderBy : predicate :reverse) | startFrom:(currentPage-1)*entryLimit | limitTo:entryLimit">
										...
										<td ng-if="data.ac_status == '0'">
											<a href="<?php echo base_url(); ?>accounts_admin/estimated_declaration_form?id={{data.tid}}&lid={{data.login_id}}"><img alt="Edit" src='<?php echo base_url('assets/images/icon/edit.png');?>'/></a>
										</td>
										...
										<td ng-if="data.ac_status == '1'"><span class="label label-primary">Approved</span></h5></td>  										
