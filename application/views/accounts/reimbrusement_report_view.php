						...
						<form id="frmReport" name="frmReport" action="" method="POST" > 
							...
							<table width="100%" cellspacing="0" cellpadding="6" border="0" class="search_box"> 
								...
								<tr>
									...
									<td><label for="books_periodical">Books & Periodical</label></td><td><input type="checkbox" class="chkColumns" class="chk" id="books_periodical" name="books_periodical" /></td>
