		...
		<div class="form-content page-content">
			<div class="mt mb">
				...
				<?php $this->load->view('accounts/top_view');?>
					...
					<a href="<?= base_url('en/accounts_admin/letter_issued_update_emp'.$get_id);?>" class="btn btn-info pull-right btn-sm" role="button" style="margin-right: 10px; margin-top: 4px;"><i class="fa fa-upload" aria-hidden="true"></i>&nbsp;Upload</a>
