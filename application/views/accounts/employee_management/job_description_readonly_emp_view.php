        ...
        <div class="form-content page-content">
            <div class="mt mb">
				...
				<?php $this->load->view('accounts/top_view');?>
					...
					<a href="<?= base_url('en/accounts_admin/job_description_update_emp'.$get_id);?>" class="btn btn-info pull-right btn-sm" role="button" style="margin-right: 10px; margin-top: 4px;"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>&nbsp;Edit</a> 
                                            ...
                                            <div class="form1 multiSelectHolder">
                                                <table class="table table-striped table-bordered table-condensed">
                                                    <tr>
                                                        ...
                                                        <td> <?php if($empInfo[0]["jd_document"] != ""){ echo "<div class='glowingtabs3'><a href='".base_url()."assets/upload/jd_goal/".$empInfo[0]["jd_document"]."' target='_blank'><span>View</span></a></div>";}?>&nbsp;</td>
                                                        <td><strong> KRA &amp; KPI:</strong></td>
                                                        <td><?php if($empInfo[0]["kpi_document"] != ""){ echo "<div class='glowingtabs3'><a href='".base_url()."assets/upload/jd_goal/".$empInfo[0]["kpi_document"]."' target='_blank'><span>View</span></a></div>";}?>&nbsp;</td>
                                                    </tr>
                                                </table>
                                            </div>
                                        </div>
                                            ...
                                            <table class="table table-striped table-bordered table-condensed">
                                                ...
                                                <tbody> 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td valign="top" width="20%"><?php echo $qryInfo[$i]['weightage']; ?></td>
                                                    </tr>
                                                    <?php  }   ?>
                                                </tbody>
                                            </table>
