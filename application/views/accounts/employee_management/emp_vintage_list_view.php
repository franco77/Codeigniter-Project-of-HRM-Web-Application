		...
		<div class="form-content page-content">
			<div class="mt mb">
				...
				<div class="col-md-9 center-xs"> 
					<legend class="pkheader">Vintage Employee Details (1) <small>(Resource of our Organisation)</small></legend> 
					<div class="row well">
									...
									<?php
										...
										if($count > 0)
										{
											for($i=0; $i < $count; $i++)
											{
												...
												?>
												<tr>
													<td><a class="link" href="profile_readonly_emp?id=<?php echo $num_rows[$i]['login_id'];?>"><?php echo $num_rows[$i]['full_name'];?></a></td>
