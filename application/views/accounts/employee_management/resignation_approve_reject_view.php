							...
							<table class="table table-striped table-hover">
								...
								<tbody>
									<tr ng-repeat="data in filtered = (getcustname | filter:search | orderBy : predicate :reverse) | startFrom:(currentPage-1)*entryLimit | limitTo:entryLimit"> 
										...
										<td>
											<span  ng-if="data.hr_status == 0" >
												<div class="iCompassTip" >
													<img  class="leaveApprove" src="<?php echo base_url(); ?>assets/images/icon/approve.png" alt="" title="Approve" ng-click="resignationApporved(data.rid);" style="cursor: pointer;" />
