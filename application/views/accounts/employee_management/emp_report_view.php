		...
		<div class="form-content page-content">
			<div class="mt mb">
				...
				<div class="col-md-9"> 
					...
					<div class="row well"> 
						<form method="POST" id="frmReport" name="frmReport" action="<?php base_url('en/accounts_admin/emp_report_export');?>">
							<div class="pad_10">
												...
												<div class="multiSelectSearchHolder">
													...
													<div id="levelBox" class="filterItem">
														...
														<div class="form-group col-md-6" style="padding:2px;">
															...
															<select id="selLevel" name="selLevel" class="selectpicker" multiple>
															<?php 
