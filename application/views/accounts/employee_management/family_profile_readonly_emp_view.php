		...
		<div class="form-content page-content">
			<div class="mt mb">
				...
				<?php $this->load->view('accounts/top_view');?>
					...
					<a href="<?= base_url('en/accounts_admin/family_update_emp'.$get_id);?>" class="btn btn-info pull-right btn-sm" role="button" style="margin-right: 10px; margin-top: 4px;"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>&nbsp;Edit</a> 
                                ...
                                for($i=0; $i< $childRows; $i++)
                                    {
                                          $j++;
                                          $childdob =  "";
                                          if($childInfo[$i]["child_dob"] != "" && $childInfo[$i]["child_dob"] != "0000-00-00"){
                                              $childdob = date("d M, Y", strtotime($childInfo[$i]["child_dob"]));
										  }
                                    ?>
                                   
                                          <table class="table table-striped table-bordered table-condensed"> 
                                              <tr class="info"><td colspan="6" class="form_title"><strong>Children Info <?php echo $j;?></strong></td></tr>
                                              <tr>
                                                  <td width="15%"><strong>Name:</strong></td>
                                                  <td width="20%"><?php echo $childInfo[$i]['child_name']?></td>
                                                  <td width="15%"><strong>Gender:</strong></td>
                                                  <td width="15%"><?php echo (($childInfo[$i]['child_gender'] == "M")?'Male':'Female')?></td>
