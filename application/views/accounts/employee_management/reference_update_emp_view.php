		...
		<div class="form-content page-content">
			<div class="mt mb">
				...
				<?php $this->load->view('accounts/top_view');?>
					<a href="<?= base_url('en/accounts_admin/reference_readonly_emp'.$get_id);?>" class="btn btn-primary pull-right" role="button" style="margin-right: 10px; margin-top: 4px;"><i class="fa fa-eye" aria-hidden="true"></i>&nbsp;View</a> 
