			...
			<div class="mt mb">
				...
				<?php $this->load->view('accounts/top_view');?>
					...
					<?php //if($this->session->userdata('user_type') != 'EMP' &&  (isset($_GET['id']))){ ?>
						<a href="<?= base_url('en/accounts_admin/salary_profile_update_emp'.$get_id);?>" class="btn btn-info pull-right btn-sm" role="button" style="margin-right: 10px; margin-top: 4px;"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>&nbsp;Edit</a> 
					<?php //} ?>
