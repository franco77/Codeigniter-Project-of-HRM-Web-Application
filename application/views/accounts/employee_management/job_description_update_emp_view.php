        ...
        <div class="form-content page-content">
            <div class="mt mb">
				...
				<?php $this->load->view('accounts/top_view');?>
					<a href="<?= base_url('en/accounts_admin/job_description_readonly_emp'.$get_id);?>" class="btn btn-primary pull-right" role="button" style="margin-right: 10px; margin-top: 4px;"><i class="fa fa-eye" aria-hidden="true"></i>&nbsp;View</a>
...
function addRow(tableID) {
			$('#add_tr').replaceWith('<tr><td><input name="chk" class="search_UI" type="checkbox"></td><td><textarea name="objective[]" class="form-control" rows="4" style="width: 200px;"></textarea></td><td><textarea name="target[]" class="form-control" rows="4" style="width: 200px;"></textarea></td><td><select name="weightage[]" class="form-control" style="width:110px;"><option>Select</option><?php for($i=1; $i<=100; $i++){ ?><option value="<?php echo $i; ?>"><?php echo $i; ?></option><?php } ?><?php for($i=1; $i<=100; $i++){ ?><option value="<?php echo $i; ?>"><?php echo $i; ?></option><?php } ?></select> <input  name="mid[]" type="hidden" value = ""></td></tr><tr id="add_tr"></tr>');
			return false;	
    }
