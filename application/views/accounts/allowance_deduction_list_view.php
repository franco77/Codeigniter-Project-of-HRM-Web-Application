    ...
    <div class="container page-content"> 
		<div class="form-content">
			<div class="mt mb">
				...
				<div class="col-md-9"> 
					<legend class="pkheader">Multiple Allowance/Deduction({{ totalItems}})</legend> 
					<div class="row well"> 
							...
							<table class="table table-striped table-bordered table-condensed table-hover">
								...
								<tbody>
									<tr ng-repeat="data in filtered = (getprofilelist | filter:search | orderBy : predicate :reverse) | startFrom:(currentPage-1)*entryLimit | limitTo:entryLimit">
										<td>{{$index+1}}</td>
										<td><a ng-href="<?php echo base_url(); ?>en/accounts_admin/multiple_allowance?empid={{data.login_id}}" ng-bind="data.name;" ></a> </td>
