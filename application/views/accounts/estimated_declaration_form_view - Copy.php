									...
									<tbody>
										...
										<tr>
											...
											<td valign="top" class="form_title">
												<input type="text" id="income_tax_declaration21" name="deduction_under_80CCD" value="<?php if($estimatedValue[0]['deduction80CCD_contribution_nps'] !='0.00'){ if(count($empInfo) > 0){ echo $empInfo[0]['deduction_under_80CCD']; } } else { echo 'NA';} ?>" class="number numbersOnly form-control" style="width:100px; margin-bottom: 10px;" />
											</td>
											<td valign="top" class="form_title">
												<input type="text" id="income_tax_declaration22" name="eligible_deduction_under_80CCD" value="<?php if($estimatedValue[0]['deduction80CCD_contribution_nps'] !='0.00'){ if(count($empInfo) > 0){ echo $empInfo[0]['eligible_deduction_under_80CCD'];} } else { echo 'NA';} ?>" READONLY class="numbersOnly form-control" style="width:100px; margin-bottom: 10px;" />
