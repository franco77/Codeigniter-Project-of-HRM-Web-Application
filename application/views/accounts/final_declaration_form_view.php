		...
		<div class="form-content">
			<div class="mt mb">
				...
				<div class="col-md-9 center-xs">
					<legend class="pkheader">Income Tax Declaration(Final) <?php 
						...
						<form id="frmSalaryUpdate" name="frmSalaryUpdate" method="POST" action="" enctype="multipart/form-data" class="form-horizontal">
							<div class="table-responsive">
								<table class="table table-striped table-bordered">
									<thead>
										<tr class="info">
											<th>For the Financial Year <?php echo (string)$empInfo[0]['fyear'].'-'.(string)($empInfo[0]['fyear']+1); ?></th>
											<th>Declared</th>
											<th>Eligible</th>
										</tr>
									</thead>
									<tbody>
										...
										<tr class="info">
											<td colspan="3" class="form_title"><strong>Exemption U/s 10</strong>
												...
												<input type="hidden" id="fyear" name="fyear" value="<?php echo $empInfo[0]['fyear'];?>"  />
											</td>
										</tr>
										<tr>
											<td valign="top"> <strong>a) Rent Paid by Employee(Per Annum)</strong></td>
											<td valign="top">
												<input type="text" id="income_tax_declaration1" name="rent_paid_by_employee" value="<?php if(count($empInfo) > 0) echo $empInfo[0]['rent_paid_by_employee'];?>" <?php if($estimatedValue[0]['rent_oaid_by_employee'] =='0.00'){ echo 'readonly ';} ?> class="numbersOnly form-control" style="width:100px; margin-bottom: 10px;" />
											</td>
											<td valign="top">
										...
										<tr>
											...
											<td valign="top">
												<input type="text" id="income_tax_declaration3" name="conv_allowance" value="<?php if($estimatedValue[0]['conv_allowance'] !='0.00'){ if(count($empInfo) > 0){ echo $empInfo[0]['conv_allowance']; } } else { echo 'NA';} ?>" <?php if($estimatedValue[0]['conv_allowance'] =='0.00'){ echo 'readonly ';} ?> class="numbersOnly form-control" style="width:100px; margin-bottom: 10px;" />
											</td>
											<td valign="top">
										...
										<tr>
											...
											<td valign="top">
												<input type="text" id="income_tax_declaration5" name="childreneducationalallowance" value="<?php if(count($empInfo) > 0) echo $empInfo[0]['childreneducationalallowance'];?>" <?php if($estimatedValue[0]['childreneducationalallowance'] =='0.00'){ echo 'readonly ';} ?> class="numbersOnly form-control" style="width:100px; margin-bottom: 10px;" />
											</td>
											<td valign="top">
												<input type="text" id="income_tax_declaration6" name="eligible_childreneducationalallowance" value="<?php if(count($empInfo) > 0) echo $empInfo[0]['eligible_childreneducationalallowance'];?>" READONLY class="numbersOnly form-control" style="width:100px; margin-bottom: 10px;" />
										...
										<tr>
											...
											<td valign="top">
												<input type="text" id="income_tax_declaration7" name="medicalexpensesperannum" value="<?php if($estimatedValue[0]['medicalexpensesperannum'] !='0.00'){ if(count($empInfo) > 0){ echo $empInfo[0]['medicalexpensesperannum']; } } else { echo 'NA';} ?>" <?php if($estimatedValue[0]['medicalexpensesperannum'] =='0.00'){ echo 'readonly ';} ?> class="numbersOnly form-control" style="width:100px; margin-bottom: 10px;" />
											</td>
											<td valign="top">
										...
										<tr>
											...
											<td valign="top">
												<input type="text" id="income_tax_declaration9" name="leavetravelconcession" value="<?php if($estimatedValue[0]['leavetravelconcession'] !='0.00'){ if(count($empInfo) > 0){ echo $empInfo[0]['leavetravelconcession']; } } else { echo 'NA';} ?>" <?php if($estimatedValue[0]['leavetravelconcession'] =='0.00'){ echo 'readonly ';} ?>class="numbersOnly form-control" style="width:100px; margin-bottom: 10px;" />
											</td>
											<td valign="top">
										...
										<tr>
											...
											<td valign="top">
												<input type="text" id="income_tax_declaration11" name="entertainment_allowance" value="<?php if($estimatedValue[0]['entertainment_allowance'] !='0.00'){ if(count($empInfo) > 0){ echo $empInfo[0]['entertainment_allowance']; } } else { echo 'NA';} ?>" <?php if($estimatedValue[0]['entertainment_allowance'] =='0.00'){ echo 'readonly ';} ?> class="numbersOnly form-control" style="width:100px; margin-bottom: 10px;" />
											</td>
											<td valign="top">
										...
										<tr>
											...
											<td valign="top">
												<input type="text" id="income_tax_declaration17" name="let_our_rented_property" value="<?php if($estimatedValue[0]['let_out_rented_property'] !='0.00'){ if(count($empInfo) > 0){ echo $empInfo[0]['let_out_rented_property']; } } else { echo 'NA';} ?>" <?php if($estimatedValue[0]['let_out_rented_property'] =='0.00'){ echo 'readonly ';} ?> class="qty6 numbersOnly form-control" style="width:100px; margin-bottom: 10px;" />
											</td>
											<td valign="top">
												<input type="text" id="income_tax_declaration18" name="eligible_let_our_rented_property" value="<?php if($estimatedValue[0]['let_out_rented_property'] !='0.00'){ if(count($empInfo) > 0){ echo $empInfo[0]['let_out_rented_property']; } } else { echo 'NA';} ?>"  readonly class="qty6 numbersOnly form-control" style="width:100px; margin-bottom: 10px;" />
										...
										<tr>
											...
											<td valign="top">
												<input type="text" id="contribution_provident_fund" name="contribution_provident_fund" value="<?php echo $get_pf; ?>" readonly class="qty1 numbersOnly form-control" style="width:100px; margin-bottom: 10px;" />
											</td>
										</tr>
										...
										<tr>
											...
											<td valign="top" class="form_title">
												<input type="text" id="income_tax_declaration21" name="deduction_under_80CCD" value="<?php if($estimatedValue[0]['deduction80C'] !='0.00'){ if(count($empInfo) > 0){ echo $empInfo[0]['deduction_under_80CCD']; } } else { echo 'NA';} ?>" class="number numbersOnly form-control" style="width:100px; margin-bottom: 10px;" />
											</td>
											<td valign="top" class="form_title">
												<input type="text" id="income_tax_declaration22" name="eligible_deduction_under_80CCD" value="<?php if($estimatedValue[0]['deduction80C'] !='0.00'){ if(count($empInfo) > 0){ echo $empInfo[0]['eligible_deduction_under_80CCD'];} } else { echo 'NA';} ?>" READONLY class="numbersOnly form-control" style="width:100px; margin-bottom: 10px;" />
												<input type="hidden" id="income_tax_declaration22_limit" name="income_tax_declaration22_limit" value="<?php echo $estimatedValue[0]['deduction80C'];?>"  />
											</td>
										</tr>
										<tr>
											<td valign="top"> <strong>Employer Contribution</strong></td>
											<td valign="top" class="form_title">
												<input type="text" id="income_tax_declaration121" name="na" value="NA" class="number numbersOnly form-control" style="width:100px; margin-bottom: 10px;" readonly />
											</td>
											<td valign="top" class="form_title">
												<input type="text" id="income_tax_declaration122" name="na" value="NA" READONLY class="numbersOnly form-control" style="width:100px; margin-bottom: 10px;" readonly />
											</td>
										</tr>
										<tr>
											<td valign="top" class="form_title"> <strong>Deductions U/s 80D (Max 25000 - Self/Family)</strong></td>
											<td valign="top" class="form_title">
												<input type="text" id="income_tax_declaration23" name="deduction_under_80D_selffamily" value="<?php if($estimatedValue[0]['selfsfamily'] !='0.00'){ if(count($empInfo) > 0){ echo $empInfo[0]['deduction_under_80D_selffamily']; } } else { echo 'NA';} ?>" <?php if($estimatedValue[0]['selfsfamily'] =='0.00'){ echo 'readonly ';} ?> class="qty2 numbersOnly form-control" style="width:100px; margin-bottom: 10px;" />
											</td>
											<td valign="top" class="form_title">
										...
										<tr>
											...
											<td valign="top" class="form_title">
												<input type="text" id="income_tax_declaration25" name="deduction_under_80D_parents" value="<?php if($estimatedValue[0]['parents'] !='0.00'){ if(count($empInfo) > 0){ echo $empInfo[0]['deduction_under_80D_parents']; } } else { echo 'NA';} ?>" <?php if($estimatedValue[0]['parents'] =='0.00'){ echo 'readonly ';} ?> class="qty2 numbersOnly form-control" style="width:100px; margin-bottom: 10px;" />
											</td>
											<td valign="top" class="form_title">
										...
										<tr>
											...
											<td valign="top" class="form_title">
												<input type="text" id="income_tax_declaration27" name="deduction_incase_senior_citizen" value="<?php if($estimatedValue[0]['deductions_senior_citizen'] !='0.00'){ if(count($empInfo) > 0){ echo $empInfo[0]['deduction_incase_senior_citizen']; } } else { echo 'NA';} ?>" <?php if($estimatedValue[0]['deductions_senior_citizen'] =='0.00'){ echo 'readonly ';} ?> class="qty2 numbersOnly form-control" style="width:100px; margin-bottom: 10px;" />
											</td>
											<td valign="top" class="form_title">
										...
										<tr>
											...
											<td valign="top">
												<input type="text" id="income_tax_declaration31" name="normal_disability" value="<?php if($estimatedValue[0]['dependants_normal_disability'] !='0.00'){ if(count($empInfo) > 0){ echo $empInfo[0]['normal_disability']; } } else { echo 'NA';} ?>" <?php if($estimatedValue[0]['dependants_normal_disability'] =='0.00'){ echo 'readonly ';} ?> class="qty3 numbersOnly form-control" style="width:100px; margin-bottom: 10px;" />
											</td>
											<td valign="top">
										...
										<tr>
											...
											<td valign="top">
												<input type="text" id="income_tax_declaration33" name="severe_disability" value="<?php if($estimatedValue[0]['dependants_severe_disability'] !='0.00'){ if(count($empInfo) > 0){ echo $empInfo[0]['severe_disability']; } } else { echo 'NA';} ?>" <?php if($estimatedValue[0]['dependants_severe_disability'] =='0.00'){ echo 'readonly ';} ?> class="qty3 numbersOnly form-control" style="width:100px; margin-bottom: 10px;" />
											</td>
											<td valign="top">
										...
										<tr>
											...
											<td valign="top">
												<input type="text" id="income_tax_declaration37" name="medical_treatment_normal_case" value="<?php if($estimatedValue[0]['meducal_norman_case'] !='0.00'){ if(count($empInfo) > 0){ echo $empInfo[0]['medical_treatment_normal_case']; } } else { echo 'NA';} ?>" <?php if($estimatedValue[0]['meducal_norman_case'] =='0.00'){ echo 'readonly ';} ?> class="qty4 numbersOnly form-control" style="width:100px; margin-bottom: 10px;" />
											</td>
											<td valign="top">
												<input type="text" id="income_tax_declaration38" name="eligible_medical_treatment_normal_case" value="<?php if($estimatedValue[0]['meducal_norman_case'] !='0.00'){ if(count($empInfo) > 0){ echo $empInfo[0]['eligible_medical_treatment_normal_case']; } } else { echo 'NA';} ?>" READONLY class="numbersOnly form-control qnt80ddb" style="width:100px; margin-bottom: 10px;" />
										...
										<tr>
											...
											<td valign="top">
												<input type="text" id="income_tax_declaration39" name="senior_citizen_60" value="<?php if($estimatedValue[0]['senior_citizen60'] !='0.00'){ if(count($empInfo) > 0){ echo $empInfo[0]['senior_citizen_60']; } } else { echo 'NA';} ?>" <?php if($estimatedValue[0]['senior_citizen60'] =='0.00'){ echo 'readonly ';} ?> class="qty4 numbersOnly form-control" style="width:100px; margin-bottom: 10px;" />
											</td>
											<td valign="top">
												<input type="text" id="income_tax_declaration40" name="eligible_senior_citizen_60" value="<?php if(count($empInfo) > 0) echo $empInfo[0]['eligible_senior_citizen_60'];?>"  READONLY class="numbersOnly form-control qnt80ddb" style="width:100px; margin-bottom: 10px;" />
										...
										<tr>
											...
											<td valign="top">
												<input type="text" id="income_tax_declaration41" name="super_senior_citizen_80" value="<?php if($estimatedValue[0]['super_senior_citizen80'] !='0.00'){ if(count($empInfo) > 0){ echo $empInfo[0]['super_senior_citizen_80']; } } else { echo 'NA';} ?>" <?php if($estimatedValue[0]['super_senior_citizen80'] =='0.00'){ echo 'readonly ';} ?> class="qty4 numbersOnly form-control" style="width:100px; margin-bottom: 10px;" />
											</td>
											<td valign="top">
												<input type="text" id="income_tax_declaration42" name="eligible_super_senior_citizen_80" value="<?php if(count($empInfo) > 0) echo $empInfo[0]['eligible_super_senior_citizen_80'];?>" READONLY class="numbersOnly form-control qnt80ddb" style="width:100px; margin-bottom: 10px;" />
										...
										<tr>
											...
											<td valign="top">
												<input type="text" id="income_tax_declaration45" name="interest_loan_higher_education_80e" value="<?php if($estimatedValue[0]['interest_loan_higher_education_80E'] !='0.00'){ if(count($empInfo) > 0){ echo $empInfo[0]['interest_loan_higher_education_80e']; } } else { echo 'NA';} ?>" <?php if($estimatedValue[0]['interest_loan_higher_education_80E'] =='0.00'){ echo 'readonly ';} ?> class="numbersOnly form-control" style="width:100px; margin-bottom: 10px;" />
											</td>
											<td valign="top">
										...
										<tr>
											...
											<td valign="top">
												<input type="text" id="income_tax_declaration47" name="interest_home_loan_80ee" value="<?php if($estimatedValue[0]['interest_home_loan_80E'] !='0.00'){ if(count($empInfo) > 0){ echo $empInfo[0]['interest_home_loan_80ee']; } } else { echo 'NA';} ?>" <?php if($estimatedValue[0]['interest_home_loan_80E'] =='0.00'){ echo 'readonly ';} ?> class="numbersOnly form-control" style="width:100px; margin-bottom: 10px;" />
											</td>
											<td valign="top">
										...
										<tr>
											...
											<td valign="top">
												<input type="text" id="income_tax_declaration49" name="actual_donation_80g" value="<?php if($estimatedValue[0]['actual_donation'] !='0.00'){ if(count($empInfo) > 0){ echo $empInfo[0]['actual_donation_80g']; } } else { echo 'NA';} ?>" <?php if($estimatedValue[0]['actual_donation'] =='0.00'){ echo 'readonly ';} ?>  class="numbersOnly form-control" style="width:100px; margin-bottom: 10px;" />
											</td>
											<td valign="top">
												<input type="text" id="income_tax_declaration50" name="eligible_actual_donation_80g" value="<?php if($estimatedValue[0]['actual_donation'] !='0.00'){ if(count($empInfo) > 0){ echo $empInfo[0]['eligible_actual_donation_80g']; } } else { echo 'NA';} ?>" READONLY class="numbersOnly form-control" style="width:100px; margin-bottom: 10px;" />
