								...
								<table class="table table-striped table-bordered">
									...
									<tbody>
										...
										<tr>
											...
											<td valign="top">
												<input type="text" id="income_tax_declaration1" name="rent_paid_by_employee" value="<?php if(count($empInfo) > 0) echo $empInfo[0]['rent_paid_by_employee'];?>" <?php if($estimatedValue[0]['rent_oaid_by_employee'] =='0.00'){ echo 'disabled ';} ?> class="numbersOnly form-control" style="width:100px; margin-bottom: 10px;" />
											</td>
											<td valign="top">
										...
										<tr>
											...
											<td valign="top">
												<input type="text" id="income_tax_declaration5" name="childreneducationalallowance" value="<?php if(count($empInfo) > 0) echo $empInfo[0]['childreneducationalallowance'];?>" <?php if($estimatedValue[0]['childreneducationalallowance'] =='0.00'){ echo 'disabled ';} ?> class="numbersOnly form-control" style="width:100px; margin-bottom: 10px;" />
											</td>
											<td valign="top">
										...
										<tr>
											...
											<td valign="top">
												<input type="text" id="contribution_provident_fund" name="contribution_provident_fund" value="<?php echo $get_pf[0]['pf']*12 ?>" disabled class="qty1 numbersOnly form-control" style="width:100px; margin-bottom: 10px;" />
											</td>
										</tr>
										...
										<tr>
											...
											<td valign="top">
												<input type="text" id="income_tax_declaration49" name="actual_donation_80g" value="<?php if($estimatedValue[0]['actual_donation'] !='0.00'){ if(count($empInfo) > 0){ echo $empInfo[0]['actual_donation_80g']; } } else { echo 'NA';} ?>" <?php if($estimatedValue[0]['actual_donation'] =='0.00'){ echo 'disabled ';} ?>  class="numbersOnly form-control" style="width:100px; margin-bottom: 10px;" />
											</td>
											<td valign="top">
