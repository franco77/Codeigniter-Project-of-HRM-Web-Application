...
$config['ci_bootstrap'] = array(
	...
	// Default page title
	'page_title' => 'AABSyS Icompass::Home',
	...
	'accounts' => array(
		...
		'my_income_tax_declaration' => array(
			...
			'children'  => array(
				...
				'My Final Declation'		=> 'accounts_help_desk/my_final_declation',
	...
	'accounts_menu' => array(
		'Estimated Tax Declaration' => array(
			'name'		=> 'Estimated Tax Declaration',
			'url'		=> 'accounts_admin/estimated_tax_declaration',
			'icon'		=> 'fa fa-users',
		),
		'Estimated Tax Computation' => array(
			'name'		=> 'Estimated Tax Computation',
			'url'		=> 'accounts_admin/estimated_tax_computation',
			'icon'		=> 'fa fa-users',
		),
		'Payroll Management' => array(
			'name'		=> 'Payroll Management', 
	...
	'menu' => array(
		...
		'aabsys_classified' => array(
			'name'		=> 'Aabsys Classified',
			'url'		=> 'aabsys_classified/classified',
		),
		'help_desk' => array(
			'name'		=> 'Help Desk',
			'url'		=> 'https://aabsys.sdpondemand.manageengine.com/Login.jsp?serviceurl=%2Fjsp%2Findex.jsp',
		), 
	),
	// Admin Menu items
	'admin_menu' => array(
