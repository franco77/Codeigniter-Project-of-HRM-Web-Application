...
{ 
	...
	public function get_official_holidays_search()
	{
		$searchYear = $this->input->post('searchYear');
		$choose_year = date("Y");
		if ($searchYear !=""){ $choose_year = $searchYear; }
		$result = $this->Resource_model->get_resource($searchYear); 
		echo json_encode($result, true); 
	}
	/*End*/
	/************* END OFFICIAL HOLIDAYS *************/
	...
	public function cricket_team()
	{
		...
		$choose_year = $this->input->get('choose_year');
		if (!$choose_year) 
		{
			$choose_year = date("Y");
		}
